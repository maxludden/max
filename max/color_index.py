...
from max.progress import MaxProgress, MaxProgressColumn

console = MaxConsole()
install_traceback(console=console)
progress = MaxProgress(console)
...
[italic #5e00ff]start[/][bold #ffffff]), a [italic]finishing index[/italic]\
([/bold #ffffff][italic #5e00ff]end[/][bold #ffffff]), which [italic]\
direction[/italic] the index flows ([/bold #ffffff][italic #5e00ff]\
invert[/][bold #ffffff]), or the length of the index ([/bold #ffffff]\
[italic #5e00ff]num_of_int[/][bold #ffffff]). However you don't need all \
